...
- ✅ **v1.3 Detection Promotion Pipeline** — Archived 2026-03-27
- ✅ **v1.4 Hunt Learning & Recommendation Engine** — Archived 2026-03-27
...
## ✅ v1.3 Detection Promotion Pipeline (Archived)

**Status:** Shipped 2026-03-27
**Archive:** `.planning/milestones/v1.3-HUNTMAP.md`
**Audit:** `.planning/milestones/v1.3-MILESTONE-AUDIT.md`

Delivered:
- detection candidate model with ATT&CK mapping, evidence linkage, and multi-format rendering
- rule generation pipeline with structural validation, noise heuristic scoring, and backtest framework
- three-gate promotion workflow with receipts, rejection audit trail, and evidence quality feedback
- CLI commands: detection map/list/generate/backtest/promote/reject/status

See the archived huntmap and phase summaries for full phase detail.

## ✅ v1.4 Hunt Learning & Recommendation Engine (Archived)

**Status:** Shipped 2026-03-27
**Archive:** `.planning/milestones/v1.4-HUNTMAP.md`
**Audit:** `.planning/milestones/v1.4-MILESTONE-AUDIT.md`
**Archived Phases:** `.planning/milestones/v1.4-phases/`

Delivered:
- hunt telemetry recording layer linking executions, packs, and promotions to hypotheses and connectors
- composite outcome scoring with analyst feedback loop (false-positive tracking, score corrections)
- recommendation engine with transparent reasoning for packs, connectors, and hypotheses
- CLI commands: metrics summary/list, score summary/entity, feedback submit/list, recommend, planning-hints
