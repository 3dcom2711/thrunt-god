...
- **Replay ID:** ${options.lineage.replay_id || 'unknown'}
- **Original Query IDs:** ${(options.lineage.original_query_ids || []).join(', ') || 'none'}
- **Original Receipt IDs:** ${(options.lineage.original_receipt_ids || []).join(', ') || 'none'}
- **Mutations Applied:** ${(options.lineage.mutations_applied || []).join(', ') || 'none'}
- **Replay Reason:** ${options.lineage.replay_reason || 'not specified'}
` : ''}`;
}
...
- **Mutations Applied:** ${(options.lineage.mutations_applied || []).join(', ') || 'none'}
- **Replay Reason:** ${options.lineage.replay_reason || 'not specified'}
- **Related Diffs:** ${(options.lineage.related_diffs || []).join(', ') || 'none'}
` : ''}`;
}
